...
const CUSTOMER_STATUS_INDEX_SQL_RE =
...
describe("TableDetail data tab toolbar", () => {
  ...
  it("renders the definition tab as a copyable schema document", () => {
    ...
    expect(screen.getByText(CREATE_TABLE_SQL_RE)).toBeTruthy();
    expect(screen.getByText(IDENTITY_COLUMN_SQL_RE)).toBeTruthy();
    expect(screen.getByText(PRIMARY_KEY_CONSTRAINT_SQL_RE)).toBeTruthy();
    expect(screen.getByText(CUSTOMER_STATUS_INDEX_SQL_RE)).toBeTruthy();
    expect(
