...
// Deliberate patches against shadcn output: CardContent leaves spacing to its
// callers, interactive items use the pointer cursor, and sonner sanitizes the
// resolved theme before passing it to Sonner.
