...
<img
  alt="PostgreSQL resource hierarchy from an instance through databases and schemas to objects"
  height="365"
  loading="lazy"
...
<div class="docs-diagram-wide">
  <img
    alt="Page-load sequence combining stored metadata with live PostgreSQL observations"
    height="790"
    loading="lazy"
