...
func (m *PostgresConfig) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetEffectiveStatementTimeout()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, PostgresConfigValidationError{
					field:  "EffectiveStatementTimeout",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetEffectiveStatementTimeout()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return PostgresConfigValidationError{
				field:  "EffectiveStatementTimeout",
				reason: "embedded message failed validation",
